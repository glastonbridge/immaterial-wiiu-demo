...
SceneAssets::SceneAssets() {
    ...
    objects.push_back(ObjectFactory::load(
        "assets/egg.fbx", "egg", materials[ID_mat_egg].get()));
    objects.push_back(ObjectFactory::load(
        "assets/egg.fbx", NULL, materials[ID_mat_egg].get()));
    objects.push_back(
    ...
    objects.push_back(ObjectFactory::load(
        "assets/sofa.fbx", NULL, materials[ID_mat_sofa].get()));
    objects.push_back(
    ...
    objects.push_back(
        ObjectFactory::createText(materials[ID_mat_text].get(),
    ...
    objects.push_back(ObjectFactory::createText(
        materials[ID_mat_text].get(), "raccoonviolet",
